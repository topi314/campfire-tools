...
func Routes(srv *server.Server) http.Handler {
	...
	mux.HandleFunc("GET /tracker/rewards/{reward_id}", h.TrackerReward)
	mux.HandleFunc("PATCH /tracker/rewards/{reward_id}", h.PostTrackerRewardEdit)
	mux.HandleFunc("GET /tracker/rewards/{reward_id}/codes", h.TrackerRewardCodes)
	mux.HandleFunc("GET /tracker/rewards/{reward_id}/edit", h.TrackerRewardEdit)
	mux.HandleFunc("DELETE /tracker/rewards/{reward_id}", h.TrackerRewardDelete)
	mux.HandleFunc("GET /tracker/rewards/{reward_id}/codes/{code_id}", h.TrackerRewardCode)
	mux.HandleFunc("DELETE /tracker/rewards/{reward_id}/codes/{code_id}", h.TrackerRewardCodeDelete)
	mux.HandleFunc("POST /tracker/rewards/{reward_id}/codes/{code_id}/next", h.TrackerRewardCodeNext)
	mux.HandleFunc("POST /tracker/rewards/{reward_id}/codes/{code_id}/mark-used", h.TrackerRewardCodeMarkAsUsed)
	mux.HandleFunc("POST /tracker/rewards/{reward_id}/codes/{code_id}/mark-unused", h.TrackerRewardCodeMarkAsUnused)
	mux.HandleFunc("POST /tracker/rewards/{reward_id}/codes/{code_id}/reserve", h.PostTrackerRewardCodeReserve)
	mux.Handle("GET /tracker/rewards/{reward_id}/codes/{code_id}/qr", middlewares.Cache(http.HandlerFunc(h.TrackerRewardCodeQR)))
